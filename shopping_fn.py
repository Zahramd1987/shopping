...
def add_product(name: str, price: int, item_number: int):
    """
    Create Product object and pass
    it to the append_product to write that in the file.
    Parameters
    ----------
    name: str :
        name of the product
...
def check_passwd(
    ...
    """
    Compare user response username and
    password with admin username and password.
    Parameters
    ----------
    admin_username : str
    ...
    -------
        out: bool
        Return True if username and password
        ill equal with admin username and password
...
def authorization():
    """
    Get username and password from user and Get
    username and password from user and
    compare it with admin's username and password
